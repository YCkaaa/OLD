...
<body>
	...
	<header class="main_head" data-parallax="scroll"
		data-image-src="img/bg2.jpg" data-z-index="1"
		data-position="top center" data-speed="0.15">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-push-4 animation_j">
						<h3>foto</h3>
						<div class="person">
							<a href="img/Krut.jpg" class="popup"><img src="img/Krut.jpg"
								alt="Alt"></a>
						</div>
					</div>
					...
					<div class="col-md-4 col-md-pull-4 padclass">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Laborum architecto odio, fugiat blanditiis facilis, minus, ipsam
							ducimus deserunt adipisci consequatur porro id delectus amet
							natus expedita odit dolorem et perspiciatis!</p>
					</div>
					...
					<div class="col-md-4 padclass">
						...
						<div class="social_wrap ">
							<a href="https://vk.com/kruttova" target="_blank"><i
								class="fa fa-vk fa-2x"></i></a> <a
								href="https://www.instagram.com/kruttova/" target="_blank"><i
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-push-4 animation_j">
						...
						<div class="person">
							<a href="img/Ann1.jpeg" class="popup"><img
								src="img/Ann1.jpeg" alt="Alt"></a>
						</div>
					</div>
					...
					<div class="col-md-4 padclass">
						...
						<div class="social_wrap">
							<a href="https://vk.com/anna_free" target="_blank"><i
								class="fa fa-vk fa-2x"></i></a> <a
								href="https://www.instagram.com/free_ann/" target="_blank"><i
								class="fa fa-instagram fa-2x"></i></a> <a
								href="https://www.facebook.com/freeanntattoo" target="_blank"><i
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-push-4 animation_j">
						...
						<div class="person">
							<a href="img/Dem.jpg" class="popup"><img src="img/Dem.jpg"
								alt="Alt"></a>
						</div>
					</div>
					...
					<div class="col-md-4 col-md-pull-4">
						...
						<p class="placeholder">Здесь будет информация о Бориславе
							Дементьеве</p>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
							Laborum architecto odio, fugiat blanditiis facilis, minus, ipsam
							ducimus deserunt adipisci consequatur porro id delectus amet
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-push-4 animation_j">
						...
						<div class="person">
							<a href="img/Ira.jpg" class="popup"><img src="img/Ira.jpg"
								alt="Alt"></a>
						</div>
					</div>
					...
					<div class="col-md-4 padclass">
						...
						<div class="social_wrap">
							<a href="https://vk.com/ira_shalfey" target="_blank"><i
								class="fa fa-vk fa-2x"></i></a> <a
								href="https://www.instagram.com/irashalfey/" target="_blank"><i
								class="fa fa-instagram fa-2x"></i></a>
						</div>
					</div>
				</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 col-md-push-4 animation_j">
						...
						<div class="person">
							<a href="img/Dron.jpg" class="popup"><img src="img/Dron.jpg"
								alt="Alt"></a>
						</div>
					</div>
					...
					<div class="col-md-4 padclass">
						...
						<div class="social_wrap">
							<a href="https://vk.com/klishetattooist" target="_blank"><i
								class="fa fa-vk fa-2x"></i></a> <a
								href="https://www.instagram.com/andrew_klishe/" target="_blank"><i
								class="fa fa-instagram fa-2x"></i></a>
						</div>
					</div>
				</div>
	...
	<section id="portfolio" class="s_portfolio">
		<div class="section_header">
			...
			<div class="s_descr_wrap">
				<div class="s_descr">
					Здесь собраны наши новые и не очень работы
					<hr align="center" width="250" color="black" />
				</div>
			</div>
		</div>
			...
			<div class="container">
				<div class="row">
					...
					<div id="portfolio_grid" class="open_image">
						<div
							class="mix col-sm-6 col-md-4 col-xs-12 portfolio_item category-1">
							<div class="thumbnail">
						...
						<div
							class="mix col-sm-6 col-md-4 col-xs-12 portfolio_item category-2">
							<div class="thumbnail">
						...
						<div
							class="mix col-sm-6 col-md-4 col-xs-12 portfolio_item category-4">
							<div class="thumbnail">
						...
						<div
							class="mix col-sm-6 col-md-4 col-xs-12 portfolio_item category-3">
							<div class="thumbnail">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6">
						<div class="contact_box">
							...
							<p>
								<span class="contacts_icon icon-basic-geolocalize-01 "></span>
								"Kharkiv, Ukraine"
							</p>
							<p>
								<span class="contacts_icon icon-basic-smartphone "></span>
								+38-050-874-08-39
							</p>
							<p>
								<span class="contacts_icon icon-basic-webpage-img-txt "></span>
								<a href="https://vk.com/oldicontattooshop.kharkov"
									target="_blank"> OLD ICON TATTOO SHOP </a>
							</p>
							<p>
								<span class="contacts_icon icon-basic-mail "></span>
					...
					<div class="col-md-6 col-sm-6">
						<form action="" class="main_form" novalidate>
							<label class="form-group"> <input type="text" name="name"
								placeholder="Ur name"
								data-validation-required-message="Enter the name" required>
								<span class="help-block text-danger"></span>
							</label> <label class="form-group"> <input type="email"
								name="email" placeholder="Ur email"
								data-validation-required-message="Invalid E-mail" required>
								<span class="help-block text-danger"></span>
							</label> <label class="form-group"> <textarea name="message"
									placeholder="Ur мессэдж"
									data-validation-required-message="Enter the comment" required></textarea>
								<span class="help-block text-danger"></span>
							</label>
							<button>Send</button>
						</form>
